...
# function for stacking images of different channels and scaling them
# to create a 2x3 stack input by row:
...
#cv2.imshow("Horizontal Stack", imgHorizontal)
#cv2.imshow("Vertical Stack", imgVert)
cv2.imshow("ImageStack Gray", imgStack)
